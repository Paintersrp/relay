...
function guidedIntegrity(value: unknown, method: WorkflowHttpMethod, path: string): GuidedIntegrity {
  ...
  return {
    discovery: {
      ...
      currentPacket: discovery.currentPacket === undefined || discovery.currentPacket === null ? null : (() => { const packet = record(discovery.currentPacket, method, path, "guided integrity closure packet"); return { closurePacketId: requiredWorkflowString(packet, "closurePacketId", method, path, "guided integrity closure packet"), sha256: requiredWorkflowString(packet, "sha256", method, path, "guided integrity closure packet") }; })(),
      history: guidedArrayOrEmpty(discovery.history, method, path, "guided integrity discovery history").map((entry) => { const value = record(entry, method, path, "guided integrity discovery revision"); return { revisionId: guidedOptionalString(value, "revisionId"), revisionNumber: typeof value.revisionNumber === "number" ? value.revisionNumber : 0, closurePacketId: guidedOptionalString(value, "closurePacketId"), packetSha256: guidedOptionalString(value, "packetSha256"), predecessorId: guidedOptionalString(value, "predecessorId"), historical: typeof value.historical === "boolean" ? value.historical : false }; }),
      reopenEvents: guidedArrayOrEmpty(discovery.reopenEvents, method, path, "guided integrity reopen events").map((entry) => { const value = record(entry, method, path, "guided integrity reopen event"); return { reopenEventId: guidedOptionalString(value, "reopenEventId"), reopenedPacketId: guidedOptionalString(value, "reopenedPacketId"), replacementRevisionId: guidedOptionalString(value, "replacementRevisionId") }; }),
    },
    authority: guidedArrayOrEmpty(item.authority, method, path, "guided integrity authority").map((revision) => { const value = record(revision, method, path, "guided integrity authority revision"); return {
      authorityRevisionId: requiredWorkflowString(value, "authorityRevisionId", method, path, "guided integrity authority revision"),
      revisionNumber: requiredWorkflowInteger(value, "revisionNumber", method, path, "guided integrity authority revision", 0),
      historical: typeof value.historical === "boolean" ? value.historical : false,
      layers: guidedArrayOrEmpty(value.layers, method, path, "guided integrity authority revision.layers").map((layer) => { const item = record(layer, method, path, "guided integrity authority layer"); return { kind: guidedOptionalString(item, "kind"), artifactId: guidedOptionalString(item, "artifactId"), sha256: guidedOptionalString(item, "sha256"), sourceClosureId: guidedOptionalString(item, "sourceClosureId") }; }),
    }; }),
    planning: guidedArrayOrEmpty(item.planning, method, path, "guided integrity planning").map((candidate) => { const value = record(candidate, method, path, "guided integrity planning candidate"); return {
      candidateId: requiredWorkflowString(value, "candidateId", method, path, "guided integrity planning candidate"),
      family: guidedOptionalString(value, "family"),
      artifactId: guidedOptionalString(value, "artifactId"),
      sha256: guidedOptionalString(value, "sha256"),
      sizeBytes: typeof value.sizeBytes === "number" ? value.sizeBytes : 0,
      historical: typeof value.historical === "boolean" ? value.historical : false,
      promoted: typeof value.promoted === "boolean" ? value.promoted : false,
      approvals: guidedStringArrayOrEmpty(value.approvals, method, path, "guided integrity planning candidate.approvals"),
    }; }),
    delivery: {
      frontier: guidedArrayOrEmpty(delivery.frontier, method, path, "guided integrity delivery.frontier").map((entry) => { const value = record(entry, method, path, "guided integrity delivery ticket"); return { ticketId: guidedOptionalString(value, "ticketId"), revisionNumber: typeof value.revisionNumber === "number" ? value.revisionNumber : 0 }; }),
      selection: delivery.selection === undefined || delivery.selection === null ? null : (() => { const selection = record(delivery.selection, method, path, "guided integrity selection"); return { selectionId: requiredWorkflowString(selection, "selectionId", method, path, "guided integrity selection"), state: guidedOptionalString(selection, "state"), ticketId: guidedOptionalString(selection, "ticketId"), revisionNumber: typeof selection.revisionNumber === "number" ? selection.revisionNumber : 0 }; })(),
      briefs: guidedArrayOrEmpty(delivery.briefs, method, path, "guided integrity delivery.briefs").map((entry) => { const brief = record(entry, method, path, "guided integrity Ticket Design Brief"); return { briefId: guidedOptionalString(brief, "briefId"), selectionId: guidedOptionalString(brief, "selectionId"), selectionState: guidedOptionalString(brief, "selectionState"), ticketId: guidedOptionalString(brief, "ticketId"), revisionNumber: typeof brief.revisionNumber === "number" ? brief.revisionNumber : 0, filename: guidedOptionalString(brief, "filename"), sha256: guidedOptionalString(brief, "sha256"), sizeBytes: typeof brief.sizeBytes === "number" ? brief.sizeBytes : 0, status: guidedOptionalString(brief, "status"), approvalId: guidedOptionalString(brief, "approvalId"), historical: typeof brief.historical === "boolean" ? brief.historical : false }; }),
      package: delivery.package === undefined || delivery.package === null ? null : (() => { const value = record(delivery.package, method, path, "guided integrity package"); return { packageId: guidedOptionalString(value, "packageId"), sha256: guidedOptionalString(value, "sha256"), approvalId: guidedOptionalString(value, "approvalId") }; })(),
      run: delivery.run === undefined || delivery.run === null ? null : (() => { const value = record(delivery.run, method, path, "guided integrity run"); return { runId: guidedOptionalString(value, "runId"), packageId: guidedOptionalString(value, "packageId"), repoTarget: guidedOptionalString(value, "repoTarget"), branch: guidedOptionalString(value, "branch"), baseCommit: guidedOptionalString(value, "baseCommit") }; })(),
      audit: delivery.audit === undefined || delivery.audit === null ? null : (() => { const value = record(delivery.audit, method, path, "guided integrity audit"); return { auditPacketId: guidedOptionalString(value, "auditPacketId"), auditDecisionId: guidedOptionalString(value, "auditDecisionId"), auditedCommit: guidedOptionalString(value, "auditedCommit") }; })(),
      remediation: delivery.remediation === undefined || delivery.remediation === null ? null : { seedIds: guidedStringArrayOrEmpty(record(delivery.remediation, method, path, "guided integrity remediation").seedIds, method, path, "guided integrity remediation.seedIds") },
    },
    prototype: item.prototype === undefined || item.prototype === null ? null : (() => {
      const value = record(item.prototype, method, path, "guided integrity prototype");
      return {
        runId: guidedOptionalString(value, "runId"),
        runState: guidedOptionalString(value, "runState"),
        proposalId: guidedOptionalString(value, "proposalId"),
        authorizationId: guidedOptionalString(value, "authorizationId"),
        approvalId: guidedOptionalString(value, "approvalId"),
        discoveryRevisionId: guidedOptionalString(value, "discoveryRevisionId"),
        cleanup: guidedArrayOrEmpty(value.cleanup, method, path, "guided integrity prototype cleanup").map((entry) => { const item = record(entry, method, path, "guided integrity prototype cleanup obligation"); return { cleanupObligationId: guidedOptionalString(item, "cleanupObligationId"), kind: guidedOptionalString(item, "kind"), status: guidedOptionalString(item, "status") }; }),
        qaPackets: guidedArrayOrEmpty(value.qaPackets, method, path, "guided integrity prototype QA packets").map((entry) => { const item = record(entry, method, path, "guided integrity prototype QA packet"); return { qaPacketId: guidedOptionalString(item, "qaPacketId"), status: guidedOptionalString(item, "status"), admissionId: guidedOptionalString(item, "admissionId"), evidence: guidedArrayOrEmpty(item.evidence, method, path, "guided integrity prototype QA evidence").map((evidence) => { const value = record(evidence, method, path, "guided integrity prototype QA evidence"); return { qaEvidenceId: guidedOptionalString(value, "qaEvidenceId"), semanticRole: guidedOptionalString(value, "semanticRole"), sha256: guidedOptionalString(value, "sha256"), sizeBytes: typeof value.sizeBytes === "number" ? value.sizeBytes : 0, mediaType: guidedOptionalString(value, "mediaType") }; }) }; }),
      };
    })(),
    diagnostics: guidedArrayOrEmpty(item.diagnostics, method, path, "guided integrity diagnostics").map((entry) => { const diagnostic = record(entry, method, path, "guided integrity diagnostic"); const condition = requiredWorkflowString(diagnostic, "condition", method, path, "guided integrity diagnostic") as GuidedIntegrity["diagnostics"][number]["condition"]; if (!(["unavailable", "unreadable", "inconsistent", "unverifiable"] as const).includes(condition)) throw new RelayApiError(`Malformed JSON response from ${method} ${path}: guided integrity diagnostic.condition is invalid`, 502, path, method); return { domain: requiredWorkflowString(diagnostic, "domain", method, path, "guided integrity diagnostic"), condition }; }),
  };
}
...
function guidedTransfer(value: unknown, method: WorkflowHttpMethod, path: string): GuidedOperationTransfer | undefined {
  ...
  return {
    ...
    ticket: ticketValue === undefined ? undefined : { ticketId: guidedOptionalString(ticketValue, "ticketId"), revisionNumber: typeof ticketValue.revisionNumber === "number" ? ticketValue.revisionNumber : 0, readiness: guidedStringArrayOrEmpty(ticketValue.readiness, method, path, "guided ticket transfer.readiness"), operationId: guidedOptionalString(ticketValue, "operationId") },
...
function guided(value: unknown, method: WorkflowHttpMethod, path: string): GuidedFeatureDetail {
  ...
  const parsedDelivery = item.delivery === undefined ? undefined : {
    ...
    briefState: guidedOptionalString(delivery, "briefState"),
  ...
  return {
    ...
    diagnostics: {
      ...
      integrity: guidedIntegrity(integrityValue, method, path),
    },
    availableActions,

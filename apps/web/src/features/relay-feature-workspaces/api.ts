...
function guided(value: unknown, method: WorkflowHttpMethod, path: string): GuidedFeatureDetail {
  ...
  const integrity = diagnostics.integrity === undefined ? {} : record(diagnostics.integrity, method, path, "guided integrity diagnostics");
  ...
  return {
    ...
    diagnostics: {
      ...
      integrity: { discovery: guidedStringArrayOrEmpty(integrity.discovery, method, path, "guided integrity discovery"), authority: guidedStringArrayOrEmpty(integrity.authority, method, path, "guided integrity authority"), planning: guidedStringArrayOrEmpty(integrity.planning, method, path, "guided integrity planning"), delivery: guidedStringArrayOrEmpty(integrity.delivery, method, path, "guided integrity delivery"), prototype: guidedStringArrayOrEmpty(integrity.prototype, method, path, "guided integrity prototype") },
    },
    availableActions,

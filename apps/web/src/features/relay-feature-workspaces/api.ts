...
function guidedIntegrity(value: unknown, method: WorkflowHttpMethod, path: string): GuidedIntegrity {
  ...
  return {
    ...
    delivery: {
      ...
      selection: delivery.selection === undefined || delivery.selection === null ? null : { selectionId: requiredWorkflowString(record(delivery.selection, method, path, "guided integrity selection"), "selectionId", method, path, "guided integrity selection") },

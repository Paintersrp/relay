...
function guidedAction(value: unknown, method: WorkflowHttpMethod, path: string, context: string): GuidedFeatureAction {
  ...
  if (!["continue_discovery", "close_discovery", "author_requirements", "author_shared_design", "author_delivery_ticket", "review_planning_candidate", "promote_planning_candidate", "continue_established_route", "complete_feature", "legacy_recovery", "reopen_discovery", "select_delivery_ticket", "author_ticket_design_brief", "review_ticket_design_brief", "prepare_package", "approve_package", "launch_run", "continue_run", "recover_run", "prepare_audit", "record_audit_decision", "remediate", "prototype_execute", "prototype_cleanup", "prototype_qa"].includes(action)) {

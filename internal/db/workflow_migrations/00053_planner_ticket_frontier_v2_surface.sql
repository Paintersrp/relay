...
-- Forward-only allowlist expansion for the evolved workspace-level Ticket
-- Frontier v2 surface. SQLite requires rebuilding the table to retain its
-- existing constraints while admitting the published Planner frontier v2
-- surface. The historical v1 surface remains valid for retained rows.
...
CREATE TABLE mcp_mutation_results_frontier_v2_next (
...
INSERT INTO mcp_mutation_results_frontier_v2_next (
...
ALTER TABLE mcp_mutation_results_frontier_v2_next RENAME TO mcp_mutation_results;

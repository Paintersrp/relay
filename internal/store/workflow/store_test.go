...
ORDER BY name`)
	...
	want := []string{
		...
		"cutover_activation_obligation_evidence",
		"cutover_activation_prerequisite_evidence",
		"cutover_activations",
		"cutover_current_states",
		"cutover_gateway_app_surface_mappings",
		"cutover_gateway_app_surfaces",
		"cutover_gateway_configurations",
		"cutover_gateway_dependency_outcomes",
		"cutover_gateway_mappings",
		"cutover_gateway_route_memberships",
		"cutover_gateway_routes",
		"cutover_gateway_standing_authorities",
		"cutover_roll_forward_criteria",
		"cutover_roll_forward_evidence",

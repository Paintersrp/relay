...
func guidedFeatureProjectionDTO(value featureapp.GuidedFeatureProjection) map[string]any {
	...
	return map[string]any{
		...
		"program":          map[string]any{"prepared": value.Program.Prepared, "dispatches": value.Program.Dispatch, "available": value.Program.Available, "handoff": value.Program.Handoff},

...
type Cleaner interface {
	...
	ReconcileStartup(context.Context, int) ([]CleanupResult, error)
}
...
var (
	...
	ErrReconciliationIncomplete   = errors.New("prototype cleanup reconciliation is incomplete")
	ErrCleanupOwnershipMismatch   = errors.New("prototype cleanup ownership mismatch")
	ErrQAPacketInvalid            = errors.New("prototype QA packet is invalid")
	ErrQAEvidenceInvalid          = errors.New("prototype QA evidence is invalid")
	ErrAnotherExecutionIneligible = errors.New("another prototype execution is ineligible")
)

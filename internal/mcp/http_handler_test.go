...
func TestHTTPHandlerToolsListUsesCanonicalProfiles(t *testing.T) {
	...
	tests := []struct {
		...
		{profile: ToolProfilePlanner, want: []string{"validate_artifact", "list_projects", "get_plan"}},
		{profile: ToolProfileAuditor, want: []string{"validate_artifact", "get_audit_packet", "get_run_artifact", "record_audit_decision"}},
		{profile: ToolProfile("local_operator"), want: []string{"validate_artifact", "list_projects", "get_plan"}},
	}
